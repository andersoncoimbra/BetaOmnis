...
<hr>
{!! Form::model($faturamento, array('route' => array('jobs.nfform',$faturamento->id), 'class'=>'form-horizontal')) !!}
...
<div class="modal-footer">
    ...
    <input type="hidden" name="job_id" value="{{$faturamento->job_id}}">
        <input type="hidden" name="id" value="{{$faturamento->id}}">
