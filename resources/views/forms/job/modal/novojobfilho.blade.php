<div class="form-horizontal">
    {!! Form::model($job, array('route' => array('post.novo.jobfilho',$job->id), 'class'=>'form-horizontal')) !!}
    <div class="form-group">
        {!! Form::label('nomeJob', 'Nome do Job Filho', array('class' => 'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
